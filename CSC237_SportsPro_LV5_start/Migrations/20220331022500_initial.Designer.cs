...
namespace CSC237_SportsPro_LV5_start.Migrations
{
    ...
    [Migration("20220331022500_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CSC237_SportsPro_LV5_start.Models.Country", b =>
                {
            ...
            modelBuilder.Entity("CSC237_SportsPro_LV5_start.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("CSC237_SportsPro_LV5_start.Models.Incident", b =>
                {
            ...
            modelBuilder.Entity("CSC237_SportsPro_LV5_start.Models.Product", b =>
                {
                    b.Property<int>("ProductID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CSC237_SportsPro_LV5_start.Models.Registration", b =>
                {
                    b.Property<int>("CustomerID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CSC237_SportsPro_LV5_start.Models.Technician", b =>
                {
                    b.Property<int>("TechnicianID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CSC237_SportsPro_LV5_start.Models.Customer", b =>
                {
                    b.HasOne("CSC237_SportsPro_LV5_start.Models.Country", "Country")
                        .WithMany()
            ...
            modelBuilder.Entity("CSC237_SportsPro_LV5_start.Models.Incident", b =>
                {
                    b.HasOne("CSC237_SportsPro_LV5_start.Models.Customer", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CSC237_SportsPro_LV5_start.Models.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CSC237_SportsPro_LV5_start.Models.Technician", "Technician")
                        .WithMany()
